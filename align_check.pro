...
;i = 14
base_path = '/System/Volumes/Data/links/mimas/sanhome2/khcho/Andy_nlfff/target3'
...
t0 = eis_info.date_obs
t1 = anytim(reltime(t0, min=10), /ccsds)
fov = 50
...
ssw_jsoc_time2data, t0, t1, $
  index_aia0, ds='aia.lev1_euv_12s', wave=193, $
  files_only=1, filenames, /silent
